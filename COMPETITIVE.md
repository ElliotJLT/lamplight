...
| **Safest Way** (safestway.co.uk) | Consumer walking-safety app (iOS/Android) + an interactive London lighting map. Aggregated street-lighting data from **all London borough councils**; "fully lit = lamp every 30m" metric. Geovation (Ordnance Survey accelerator) startup. Covers London, NI, York, Manchester | Council lighting + CCTV + crime data, closed | The most direct overlap — proves the London council aggregation is doable and demanded. But: walking + personal-safety positioning (CCTV/crime), consumer app, closed data, no API/embed offering. The open, runner-focused, B2B-embeddable position is still vacant. Watch closely; possible partner or fast-follow threat if they pivot B2B |
